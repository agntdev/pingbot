# E3T1 — Implement /count command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 PING

Handle /count command to display the total number of pings. Write dialog spec to tests/specs/E3T1.json and append command to tests/commands.json.
