...
Set up SQLite database schema with a `counter` table. Initialize the counter to 0. Handle atomic updates during /ping command. Write unit tests for database operations.
