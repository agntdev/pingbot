# E2T1 — Implement /ping command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 PING

Handle /ping command to increment the global counter atomically and reply 'pong'. Write dialog spec to tests/specs/E2T1.json and append command to tests/commands.json.
